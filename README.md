 ...
 * *Dimensions:* Outer diameter tailored to fit standard rocket payload bays (6.8\text{ cm}).
  ![Mekanik görünüş1](images/cansat_1.png)
![Mekanik görünüş2](images/cansat_2.png)
![Mekanik görünüş3](images/cansat_3.png)
![Mekanik görünüş patlamış](images/cansat_exploded.png)
...
![Yer İstasyonu Arayüzü](images/ground_station_iu.png)
